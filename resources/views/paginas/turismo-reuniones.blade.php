...
<section class="container">
  <div class="row">
    <div class="col-md-4 actividades" style="background-image: url('public/img/turismo/reuniones/1.jpg')"></div>
    <div class="col-md-8 actividades" style="background-image: url('public/img/turismo/reuniones/5.jpg')"></div>
  </div>
  <div class="row">
    <div class="col-md-6 actividades" style="background-image: url('public/img/turismo/reuniones/7.jpg')"></div>
    <div class="col-md-6 actividades" style="background-image: url('public/img/turismo/reuniones/9.jpg')"></div>
  </div>
</section>
  <section class="container">
      <div class="row">
    ...
    <div class="row">
      <div class="col-md-8 actividades" style="background-image: url('public/img/turismo/reuniones/4.jpg')"></div>
      <div class="col-md-4 actividades" style="background-image: url('public/img/turismo/reuniones/3.jpg')"></div>
    </div>
    <div class="row">
      <div class="col-md-6 actividades" style="background-image: url('public/img/turismo/reuniones/6.jpg')"></div>
      <div class="col-md-6 actividades" style="background-image: url('public/img/turismo/reuniones/2.jpg')"></div>
    </div>
  </section>
     <section class="container">
          <div class="row">
       ...
       La Ciudad, cuenta con salones totalmente equipados para Eventos y Reuniones. Cuentan con salas de conferencias, climatizadas y con equipos de proyección y sonido. Combine su evento, con las actividades del hotel, destacándose aquellas referidas al Spa y el relax, la gastronomía y la distensión. Las salas, se ambientan según los requerimientos de los organizadores, con equipamiento completo y la opción de trabajar out-door  en los jardines de los hoteles.  </p>
           ...
           <div class="row">
             <div class="col-md-8 actividades" style="background-image: url('public/img/turismo/reuniones/10.jpg')"></div>
             <div class="col-md-4 actividades" style="background-image: url('public/img/turismo/reuniones/8.jpg')"></div>
           </div>
     </section>
    ...
    <div class="col-md-8 col-md-offset-2" style="text-align: center">
        ...
        <div class="row">
            ...
            <div class="col-md-2 col-md-offset-2 servicio">
              <img src="public/img/turismo/reuniones/salones.jpg" alt="Salones en Lobos">

                  <h5>Salones</h5>

              </div> <!-- Salones -->
            <div class="col-md-2 servicio">
              <img src="public/img/turismo/reuniones/audiovisual.jpg" alt="Servicios audiovisuales en Lobos">

                  <h5>Audiovisual</h5>

              </div> <!-- Audiovisual-->
            <div class="col-md-2 servicio">
              <img src="public/img/turismo/reuniones/catering.jpg" alt="Catering en Lobos">

                  <h5>Catering</h5>

              </div> <!-- Catering-->
            <div class="col-md-2 servicio">
              <img src="public/img/turismo/reuniones/transporte.jpg" alt="Transportes a Lobos">
